...
labelIdValue loc (LabelIdValue x) = printError $ (loc, "passed string contains invalid chars, got \"" ++ x ++ "\""):[sourcePos||]
labelIdValue loc LabelIdValueHaskell{} = printError $ (loc, "parsed string still not executed"):[sourcePos||]
